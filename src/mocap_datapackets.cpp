...
const geometry_msgs::Point Marker::get_3d_point()
{
  ...
  // point.x=0.99366419* _x + 0.11160959 * _y + -0.01322022*_z-0.36006935;
  // point.y=-0.11190765 * _x + 0.99341674*_y-0.02449184*_z-0.05084220;
  // point.z=0.01039967 * _x+0.02581611 * _y + 0.99961261* _z + 0.04922528;

  // [[0.99366419, 0.11160959, -0.01322022,]
  // [-0.11190765, 0.99341674, -0.02449184,]
  // [0.01039967, 0.02581611, 0.99961261,]]
